...
public class OSSClientUtil {
    ...
    private String accessKeyId = "LTAI4FsBQgV312U1ZVJb23WL";
    private String accessKeySecret = "J61AuhHefEEJB0MT1IjgGPazZphXpv";
    // 空间
    private String bucketName = "1904a6";
    // 文件存储目录
    private String filedir = "imp/";
